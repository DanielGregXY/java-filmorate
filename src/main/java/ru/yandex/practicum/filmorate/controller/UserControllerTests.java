...
public class UserControllerTests {
    ...
    @Test
    void emailBlancTest() {
        user = new User(null, "login", LocalDate.of(1990, 8, 25));
    ...
    @Test
    void loginBlancTest() {
        user = new User("test@test.ru", " ", LocalDate.of(1990, 8, 25));
        Set<ConstraintViolation<User>> violations = validator.validate(user);
        assertFalse(violations.isEmpty());
        assertThat(violations.size()).isEqualTo(1);
    }
    ...
    @Test
    void loginNullTest() {
        user = new User("test@test.ru", null, LocalDate.of(1990, 8, 25));
        Set<ConstraintViolation<User>> violations = validator.validate(user);
        assertFalse(violations.isEmpty());
        assertThat(violations.size()).isEqualTo(1);
    }
